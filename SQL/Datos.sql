...
call registrarEstudiante(202003896, 'Diego', 'Pacay', '2001-12-30','digoPacay@gmail.com', 3456234, 'Colinas', 2986624050101, 2);

call registrarDocente('Javier', 'Espino', '1990-10-11','espino@gmail.com', 46424534, 'Mixco',34524213, 5635463);

call crearCurso(1, 'Matematica', 0, 5, 0, 0);
call crearCurso(11, 'Bases de datos', 5, 3, 1, 1);
...
-- call ingresarNota(1,'vj','a',202003895,31);

call generarActa(1, 'vj', 'a');

call consultarPensum(1);

call consultarEstudiante(202003896);

call consultarDocente(5635463);

call consultarAsignados(1, 'vj', 2023, 'a');

call consultarActas(1); 

call consultarDesasignacion(1, 'vj', 2023, 'a');